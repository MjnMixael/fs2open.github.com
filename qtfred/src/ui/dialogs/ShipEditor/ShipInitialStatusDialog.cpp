...
void ShipInitialStatusDialog::on_hasShieldCheckBox_stateChanged(int state)
{
	_model->setHasShield(state);
}
void ShipInitialStatusDialog::on_shieldHullSpinBox_valueChanged(int value)
{
	_model->setShieldHull(value);
}
void ShipInitialStatusDialog::on_forceShieldsCheckBox_stateChanged(int state)
{
	_model->setForceShield(state);
}
void ShipInitialStatusDialog::on_shipLockCheckBox_stateChanged(int state)
{
	_model->setShipLocked(state);
}
void ShipInitialStatusDialog::on_weaponLockCheckBox_stateChanged(int state)
{
	_model->setWeaponLocked(state);
}
void ShipInitialStatusDialog::on_primaryLockCheckBox_stateChanged(int state)
{
	_model->setPrimariesDisabled(state);
}
void ShipInitialStatusDialog::on_secondaryLockCheckBox_stateChanged(int state)
{
	_model->setSecondariesDisabled(state);
}
void ShipInitialStatusDialog::on_turretLockCheckBox_stateChanged(int state)
{
	_model->setTurretsDisabled(state);
}
void ShipInitialStatusDialog::on_afterburnerLockCheckBox_stateChanged(int state)
{
...
void ShipInitialStatusDialog::on_cancelPushButton_clicked() {
	reject();
}
