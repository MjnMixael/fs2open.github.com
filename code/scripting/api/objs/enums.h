...
enum lua_enum : int32_t {
	...
	LE_OVERHEAD_STYLE_TOP,
	LE_OVERHEAD_STYLE_ROTATE,
	LE_OVERHEAD_STYLE_LEFT,
	LE_OVERHEAD_STYLE_RIGHT,
	LE_OVERHEAD_STYLE_BOTTOM,
	LE_OVERHEAD_STYLE_FRONT,
	LE_OVERHEAD_STYLE_BACK,
	ENUM_NEXT_INDEX,
	ENUM_COMBINATION,
	ENUM_INVALID
};
