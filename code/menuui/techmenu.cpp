...
void techroom_ships_render(float frametime)
{
	...
	const auto instance_type = (Tab == SHIPS_DATA_TAB) ? cached_ui_render_instance_type::tech_room : cached_ui_render_instance_type::overhead;
	int model_instance = model_get_cached_ui_render_instance(Techroom_modelnum, instance_type);
	if (Tab == SHIPS_DATA_TAB) {
