...
Flag exe_params[] = 
{
	...
	{ "-output_script_lstb",	"Output scripting doc to scripting.lua",	true,	0,								EASY_DEFAULT,					"Dev Tool",		"http://www.hard-light.net/wiki/index.php/Command-Line_Reference#-output_script_luastub", },
...
cmdline_parm output_script_luastub_arg("-output_script_lstb", nullptr, AT_NONE); // mjnmixael
