...
class ship_info;
class weapon_info;
void draw_model_icon(int model_id, uint64_t flags, int x1, int x2, int y1, int y2, ship_info* sip = nullptr, weapon_info* wip = nullptr, float closeup_zoom_scale = 1.0f, int resize_mode = GR_RESIZE_FULL);
